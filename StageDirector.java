...
{
	private String nameDir;     // Имя Работников постановочной группы
	...
	{   // Возвращение имени Работников
		return nameDir;
	}

	public String getSurnameDir()
	{   // Возвращение фамилии Работников
		return surnameDir;
	}

	public int getAgeDir()
	{   // Возвращение возраста Работника
		return ageDir;
	}

	public Theatre getJobPlace()
	{   // Возвращение места работы Работнико
		return jobPlace;
	}

	public Performance getPerformanceDir(int num)
	{   // Возвращение постановки с участ. Работников
		return performanceDir[num];
	}

	public int getRoles()
	{   // Возвращение кол-ва работ
		return roles;
	}
